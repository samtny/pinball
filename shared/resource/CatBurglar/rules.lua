...
function handleSwitchClosed(switch, ball)
...
function handleSwitchOpened(switch, ball)
	if switch == "troughSwitch" then
		troughSwitchOpened(ball)
	elseif switch == "lbutton" then
...
function troughSwitchClosed(ball)
...
function sleepBall(ball)
	-- C API stub
	print "sleepBall"
end

function troughSwitchOpened(ball)
